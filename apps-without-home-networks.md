...
The [connectivity flows companion](app-connectivity-flows.md) shows an app traversing all three styles end-to-end (registration, record location, data retrieval) with no home network anywhere in the path.
