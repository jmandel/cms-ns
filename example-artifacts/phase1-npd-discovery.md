...
*Worked example for [the registration and connectivity walkthrough](../app-connectivity-flows.md). Plain JSON, no signatures: the app (or its client library) learns how each network handles registration.*
