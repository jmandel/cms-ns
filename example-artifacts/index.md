...
- [Core story — the authorization step's token response](issuance-token-response.md)
- [Core story — a signed permission ticket and its redemption](permission-ticket.md)
